...
const Hero = () => {
  return (
    <header className="relative bg-purple-50 flex flex-col lg:flex-row pb-5 px-[20px] w-full min-h-[500px] max-container rounded-b-[20px] lg:h-[598px] lg:flexBetween">
      {/* <Hamburger /> */}
      <div className="mt-12  lg:mt-0 lg:w-8/12 flexBetween max-md:order-2 flex-col lg:h-[518px]">
        <h1 className="regular-100 mt-16 text-black-10">I create <span className="text_gradient italic">stunning</span> design solutions to problems</h1>
        <p className="regular-14 mt-6 lg:mt-0 w-full leading-[22px] text-black-10">Available for freelance work</p>
      </div>
      
      <div className="flex mt-9 lg:mt-0 max-md:h-1/2  order-1 w-full lg:w-6/12">
